        ...
        <>
            <div className="sticky top-0 z-4">
                ...
                >
                    <span
                        className={cn(
                            'inline-block w-3/5 h-0.5 bg-foreground rounded-full absolute left-1/2 -translate-x-1/2 top-1/2 duration-300 -translate-y-1.25 ',
                            {
            ...
            <div
                className={cn(
                    'fixed top-0 right-0 h-dvh w-125 max-w-[calc(100vw-3rem)] transform translate-x-full transition-transform duration-700 z-3 overflow-hidden gap-y-14',
